...
public class PrismaSegitiga extends Segitiga {
    ...
    public double menghitungLuasPermukaan(double alasBaru, double tinggiBaru, double sisiMiring1Baru, double sisiMiring2Baru,
        ...
        if (jawaban.equalsIgnoreCase("Y")) {
            while (true) {
                try {
                    ...
                    if (alasBaru <= 0 || tinggiSegitigaBaru <= 0 || sisiMiring1Baru <= 0 || sisiMiring2Baru <= 0 || tinggiPrismaBaru <= 0) {
