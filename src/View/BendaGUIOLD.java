 ...
 * @author ASUS
 */
public class BendaGUIOLD extends javax.swing.JFrame {
    ...
    public BendaGUIOLD(Benda2D benda) {
        initComponents();
        String namaBenda = benda.getNamaBenda();
        String[] params = benda.getParameterNames();
        ...
        luasLabel2.setText("<html> Apakah Anda ingin Mengubah Nilai " + joinedParams + " dari " + namaBenda + " </html>");
        ...
        for (int i = 0; i < params.length; i++) {
            ...
            textField.setName(params[i]);
            loopPanel.add(textField);
        }
        benda.menghitungLuas(joinedParams);
        benda.menghitungKeliling(joinedParams);
    ...
    private void initComponents() {
        ...
        hitungButton.setBackground(new java.awt.Color(98, 181, 66));
        hitungButton.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        ...
        setSize(new java.awt.Dimension(626, 612));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BendaGUIOLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                BendaGUIOLD ui = new BendaGUIOLD();
//                ui.setLocationRelativeTo(null);
//                ui.setVisible(true);
            }
        });
