...
public class DialogPerhitunganStatis extends JFrame {
    private JTextArea areaHasil;
    private String namaBentuk = "Persegi"; // Nilai default untuk contoh
    private String[] labelInput = {"Sisi"}; // Nilai default untuk contoh
    private double[] nilaiStatis = {5.0}; // Nilai default untuk contoh
    private boolean lanjutKeDinamis = false;

    public DialogPerhitunganStatis() {
    ...
    private void inisialisasiFrame() {
        ...
        setLayout(null); // Menggunakan layout relative null
        setSize(600, 500);
        setResizable(false);
    ...
    private void hitungDanTampilkan() {
        try {
            ...
            double luas = nilaiStatis[0] * nilaiStatis[0]; // Luas persegi
            double keliling = 4 * nilaiStatis[0]; // Keliling persegi
    ...
    private void onLanjutKeDinamis(ActionEvent e) {
        ...
        // Contoh pemanggilan frame dinamis
        SwingUtilities.invokeLater(() -> {
            DialogPerhitunganDinamis dinamis = new DialogPerhitunganDinamis();
            dinamis.setLocationRelativeTo(null);
            dinamis.setVisible(true);
        });
    }

    public boolean apakahLanjutKeDinamis() {
        return lanjutKeDinamis;
    }

    public static void main(String[] args) {
        // Contoh penggunaan
        SwingUtilities.invokeLater(() -> {
            DialogPerhitunganStatis ui = new DialogPerhitunganStatis();
...
class DialogPerhitunganDinamis extends JFrame {
    // Implementasi sederhana untuk contoh
    public DialogPerhitunganDinamis() {
        setTitle("Perhitungan Dinamis");
        setSize(400, 300);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        getContentPane().add(new JLabel("Dialog Dinamis", SwingConstants.CENTER));
    }
}